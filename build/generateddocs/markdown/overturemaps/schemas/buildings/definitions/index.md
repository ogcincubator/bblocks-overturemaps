...
# Overture Maps Shared Building Properties (Schema)

`ogc.overturemaps.schemas.buildings.definitions` *v0.1*

Common schema definitions shared by building footprints and building parts
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-overturemaps/build/annotated/overturemaps/schemas/buildings/definitions/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-overturemaps/build/annotated/overturemaps/schemas/buildings/definitions/schema.yaml)
...
* Path: `_sources/schemas/buildings/definitions`
