  ...
  properties:
    ...
    - title: Common Segment Properties
      properties:
        ...
        level:
          $ref: https://github.com/OvertureMaps/schema/raw/refs/heads/dev/schema/defs.yaml#/$defs/propertyDefinitions/level
        level_rules:
        ...
        items:
          ...
          properties:
            connector_id:
              $ref: https://github.com/OvertureMaps/schema/raw/refs/heads/dev/schema/defs.yaml#/$defs/propertyDefinitions/id
            at:
              $ref: https://github.com/OvertureMaps/schema/raw/refs/heads/dev/schema/defs.yaml#/$defs/propertyDefinitions/linearlyReferencedPosition
        uniqueItems: true
        minItems: 2
        default: []
      routes:
...
$defs:
  propertyDefinitions:
    ...
    routes:
      ...
      items:
        ...
        unevaluatedProperties: false
        allOf:
        - $ref: https://github.com/OvertureMaps/schema/raw/refs/heads/dev/schema/defs.yaml#/$defs/propertyContainers/geometricRangeScopeContainer
        properties:
          name:
  ...
  propertyContainers:
    ...
    temporalScopeContainer:
      ...
      properties:
        during:
          $ref: https://github.com/OvertureMaps/schema/raw/refs/heads/dev/schema/defs.yaml#/$defs/propertyDefinitions/openingHours
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/ogcincubator/bblocks-overturemaps/undefined/build/annotated/overturemaps/schemas/transportation/segment/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/ogcincubator/bblocks-overturemaps/undefined/build/annotated/overturemaps/schemas/transportation/segment/schema.yaml)
